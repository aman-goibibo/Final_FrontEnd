...
class DashBoard extends Component {
  ...
  async fetchData(tag) {
    ...
    var params = {
      client_id:
        "0c818841f7cdf80f3c67be359441bf7e3a0982757411a1faffbf6c0cdad7d205",
      query: tag
    };
    ...
    await fetch(hit_url, {
      headers: {
        Authorization:
          "563492ad6f91700001000001c3b17333909346f89919fd61da20522a"
      }
    })
      .then(res => res.json())
      .then(body => {
  ...
  render() {
    return (
      <div>
        ...
        {this.state.showImages ? this.displayImages() : null}
      </div>
    );
  }
}
